...
class PetAdmin(admin.ModelAdmin):
    list_display = ('name', 'category', 'price', 'stock_quantity', 'gender', 'is_available', 'created_by', 'image_preview', 'created_at')  # ← เพิ่ม stock_quantity
    list_filter = ('category', 'gender', 'is_available', 'created_at')
    search_fields = ('name', 'description', 'category__name')
    list_editable = ('price', 'is_available', 'stock_quantity')  # ← เพิ่ม stock_quantity
    ...
    fieldsets = (
        ...
        ('Stock Management', {  # ← เพิ่ม section ใหม่สำหรับจัดการสต็อก
            'fields': ('stock_quantity', 'min_stock_threshold', 'is_available'),
            'description': 'จัดการจำนวนสต็อกและการขาย'
        }),
        ('Image Options', {
